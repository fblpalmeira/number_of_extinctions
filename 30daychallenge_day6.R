...
png(file = "extinct-species-since-1500.png", width = 650, height = 400)
df3 <- hclust(dist(df2))
df3
...
avg_col_dend %>% rect.dendrogram(k = 4, horiz = TRUE, border = 8, lty = 2, lwd = 1)
dev.off()
...
plot3<-image_annotate(plot2, "Data source: ourworldindata.org/extinctions | Data published by IUCN Red List | Visualization by @fblpalmeira", color = "gray", size = 12, 
